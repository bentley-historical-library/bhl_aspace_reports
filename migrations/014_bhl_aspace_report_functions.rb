...
CREATE FUNCTION BHL_GetCoordinate(f_location_id INT) 
    RETURNS VARCHAR(1020) CHARSET utf8mb3
    READS SQL DATA
BEGIN
    DECLARE f_coordinate VARCHAR(1020) CHARSET utf8mb3; 
        DECLARE f_coordinate_1 VARCHAR(255) CHARSET utf8mb3;
        DECLARE f_coordinate_2 VARCHAR(255) CHARSET utf8mb3;
        DECLARE f_coordinate_3 VARCHAR(255) CHARSET utf8mb3;
...
BEGIN
    DECLARE f_value VARCHAR(255) CHARSET utf8mb3;   
    DECLARE f_ovalue VARCHAR(255) CHARSET utf8mb3;        
...
BEGIN
    DECLARE f_value VARCHAR(255) CHARSET utf8mb3;
        DECLARE f_date VARCHAR(255) CHARSET utf8mb3;
        DECLARE f_expression VARCHAR(255) CHARSET utf8mb3;
        DECLARE f_begin VARCHAR(255) CHARSET utf8mb3;
        DECLARE f_end VARCHAR(255) CHARSET utf8mb3;
...
CREATE FUNCTION BHL_GetResourceExtentNumberType(f_resource_id INT) 
    ...
    READS SQL DATA
BEGIN
    DECLARE f_value VARCHAR(1020) CHARSET utf8mb3;
